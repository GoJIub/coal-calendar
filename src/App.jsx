...
function App() {
  ...
  const [activeView, setActiveView] = useState('calendar'); // 'calendar' или 'map'
      ...
      <main className="main-content">
        <div className="center-area">
          <div className="side-buttons-mockup">
            <button 
              className={`side-btn-mockup ${activeView === 'calendar' ? 'active' : ''}`}
            ...
            <button 
              className={`side-btn-mockup ${activeView === 'map' ? 'active' : ''}`}
            ...
            <button className="side-btn-mockup">
          ...
          <div className="center-window">
            {activeView === 'calendar' ? <Calendar /> : <Map />}
          </div>
        </div>
      </main>
      ...
      {showInstructionModal && (
        <div className="modal-overlay" onClick={() => setShowInstructionModal(false)}>
          <div className="modal-content instruction-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body instruction-body" dangerouslySetInnerHTML={{ __html: marked.parse(instructionMd) }} />
          </div>
        </div>
      )}
    </div>
